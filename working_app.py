...
# Bollinger Bands
MA_30 = data['Close'].rolling(30).mean()
STD_20 = data['Close'].rolling(20).std()

UpperB = MA_30 + (2*STD_20)
LowerB = MA_30 - (2*STD_20)
...
ap0 = [
    mpf.make_addplot(data['Volume'], type='bar', ylim=(0, 4*data['Volume'].max()), panel=1, color='#00ffe8'),
    # RSI related plots
    mpf.make_addplot(rsi, panel=0, ylim=(0,100), color='#00ffe8', width=0.5),
    ...
    # MACD related plots
    mpf.make_addplot(exp12, width=0.7, panel=1),
    mpf.make_addplot(exp26, width=0.7, panel=1),
    mpf.make_addplot(histogram, type='bar', width=0.5, panel=2, alpha=1, secondary_y=False),
    mpf.make_addplot(macd, panel=2, secondary_y=True, width=0.7),
    mpf.make_addplot(signal, panel=2, secondary_y=True, width=0.7),

    # ADX related plots
    mpf.make_addplot(negDI, panel=3, ylim=(0, 100), width=0.7),
    mpf.make_addplot(posDI, panel=3, ylim=(0, 100), width=0.7),
    mpf.make_addplot(adx, panel=3, ylim=(0, 100), width=0.7),
    mpf.make_addplot(data['adx_line'], panel=3, width=0.7),

    # Bollinger related plots
    mpf.make_addplot(UpperB, width=0.7, panel=1),
    mpf.make_addplot(LowerB, width=0.7, panel=1)
    ]
...
def animate(ival):
    ...
    ap0 = [
        mpf.make_addplot(df['Volume'], type='bar', ylim=(0, 4*data['Volume'].max()), panel=1, color='#00ffe8', ax=ax_volu),
           # MACD related plots
           ...
           # Bollinger related plots
            mpf.make_addplot(UpperB, width=0.7, panel=1, ax=ax_upper),
            mpf.make_addplot(LowerB, width=0.7, panel=1, ax=ax_lower)
           ]
